              ...
              {page.map((row: any) => {
                ...
                return (
                  <tr
                    ...
                    onClick={()=>{
                      localStorage.setItem("selected", JSON.stringify(row.original))
                      row.cells[5].value == "Pending" ?  navigate("/dts/home/document/process/form") : navigate("/dts/home/document/completed/form")
...

                    {
                      ...
                      switch (cell.column.id) {
                        ...
                        case "status":
                          ...
                          <td key={cell.column.id} className=" h-10 pl-4 py-4 text-left truncate ">
                              <button className='rounded-[4px]   border-[1px] text-xs w-1/2 border-[#008767] bg-[#a6e7d8] text-[#008767] font-md px-2 py-1 sm:py-1 sm:px-1 hover:bg-opacity-50 sm:items-center sm:justify-center'>
                                <p className=' sm:hidden truncate '>Received</p>
                              </button>
                            </td>
